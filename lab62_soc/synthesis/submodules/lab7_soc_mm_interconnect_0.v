...
module lab7_soc_mm_interconnect_0 (
	...
	wire   [14:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> leds_pio_s1_agent:cp_channel
	...
	wire   [14:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> usb_irq_s1_agent:cp_channel
	...
	wire  [105:0] cmd_demux_001_src14_data;                                                           // cmd_demux_001:src14_data -> cmd_mux_014:sink0_data
	...
	wire  [105:0] rsp_demux_014_src0_data;                                                            // rsp_demux_014:src0_data -> rsp_mux_001:sink14_data
	...
	lab7_soc_mm_interconnect_0_router_016 router_016 (
	...
	lab7_soc_mm_interconnect_0_cmd_mux_014 cmd_mux_014 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (usb_irq_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux_014 rsp_demux_014 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (usb_irq_reset_reset_bridge_in_reset_reset), // clk_reset.reset
