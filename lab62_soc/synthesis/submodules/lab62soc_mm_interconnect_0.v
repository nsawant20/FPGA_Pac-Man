...
module lab62soc_mm_interconnect_0 (
		...
		input  wire        usb_irq_reset_reset_bridge_in_reset_reset,      //      usb_irq_reset_reset_bridge_in_reset.reset
	...
	wire   [13:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> leds_pio_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> hex_digits_pio_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_011_src_channel;                                                            // cmd_mux_011:src_channel -> usb_rst_s1_agent:cp_channel
	...
	wire   [13:0] cmd_mux_013_src_channel;                                                            // cmd_mux_013:src_channel -> usb_irq_s1_agent:cp_channel
	...
	wire  [105:0] cmd_demux_001_src13_data;                                                           // cmd_demux_001:src13_data -> cmd_mux_013:sink0_data
	...
	wire  [105:0] rsp_demux_013_src0_data;                                                            // rsp_demux_013:src0_data -> rsp_mux_001:sink13_data
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                             //                      clk.clk
		.reset                  (usb_irq_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                               //             clk.clk
		.reset                   (usb_irq_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	lab62soc_mm_interconnect_0_router_015 router_015 (
	...
	lab62soc_mm_interconnect_0_cmd_mux_013 cmd_mux_013 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (usb_irq_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab62soc_mm_interconnect_0_rsp_demux_013 rsp_demux_013 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (usb_irq_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab62soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (usb_irq_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
